...
function HomeScreen({ userProfile, onNavigate }) {
  const getCards = () => {
    if (userProfile.role === "admin") return [
      ...
      { icon: "📋", label: "Quién Trabaja", screen: "whoIsWorking" },
      { icon: "🏖️", label: "Vacaciones Empleados", screen: "employeeVacations" },
  ...
  return (
    <div>
      ...
      <div className="nav-tabs">
        ...
        {userProfile.role === "admin" && <button className={`nav-tab ${screen === "whoIsWorking" ? "active" : ""}`} onClick={() => setScreen("whoIsWorking")}>Quién Trabaja</button>}
        {userProfile.role === "admin" && <button className={`nav-tab ${screen === "employeeVacations" ? "active" : ""}`} onClick={() => setScreen("employeeVacations")}>Vacaciones Empleados</button>}
        {userProfile.role === "admin" && <>
